                    ...
                    <div class="card">
                        ...
                        <x-form class="card__content" action="{{ route('register') }}">
                            ...
                            <div class="form__group">
                                <x-label class="label" for="email" />
                                <x-input class="input input--medium" type="email" name="email" />
                            </div>
                            ...
                            <div class="form__group">
                                <x-label class="label" for="password_confirmation" />
                                <x-input class="input input--medium" type="password" name="password_confirmation" />
                            </div>
